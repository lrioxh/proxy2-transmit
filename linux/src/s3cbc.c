                           ...
                           const unsigned char *mac_secret, size_t mac_secret_length, char is_sslv3)
{
    ...
    size_t sslv3_pad_length = 40, header_length, variance_blocks, len, max_mac_bytes, num_blocks,
     ...
     */
    variance_blocks =
        is_sslv3 ? 2 : (((255 + 1 + md_size + md_block_size - 1) / md_block_size) + 1);
    /*
